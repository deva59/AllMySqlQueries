...
select * from Title;
 ...
 -- Q-1.WriteanSQLquerytofetch“FIRST_NAME”fromWorkertableusing--
  --  thealiasnameas<WORKER_NAME>.--
...
-- Q-2.WriteanSQLquerytofetch“FIRST_NAME”fromWorkertablein
 -- uppercase --
 
    select upper(FIRST_NAME) as FIRST_NAME from Worker1;
    
   -- Q-3 .WriteanSQLquerytofetchuniquevaluesofDEPARTMENTfrom
 -- Workertable. --
